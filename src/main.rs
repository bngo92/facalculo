...
mod tests {
    ...
    fn advanced_circuit() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "0.167 copper-cable -> 0.167 -> 0.267 copper-plate",
                "0.250 copper-cable -> 0.250 -> 0.400 copper-plate",
                "0.267 copper-plate -> 0.167 -> 0.333 copper-ore",
                "0.400 copper-plate -> 0.250 -> 0.500 copper-ore",
    ...
    fn group_all_advanced_circuit() {
        ...
        assert_eq!(
            ...
            vec![
                " -> 0.083 -> 1 advanced-circuit",
                "1 advanced-circuit -> 0.333 -> 0.417 copper-cable",
                "1 advanced-circuit -> 0.167 -> 0.167 electronic-circuit",
                "1 advanced-circuit -> 0.167 -> 0.083 plastic-bar",
